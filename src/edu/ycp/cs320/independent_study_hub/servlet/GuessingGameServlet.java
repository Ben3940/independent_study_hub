...
public class GuessingGameServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		// client and the server every time in order to remember them
			...
			// find the thing that is labeled as "min" convert it to an integer (getInteger) and store is under curMin
			...
			// These are the button names (i.e. gotIt, less, more).  We call the controllers' appropriate method when these buttons are pressed
			if (req.getParameter("gotIt") != null) {
				...
				//Catches code that was not completely implemented (i.e. added a button but does nothing when pressed)
